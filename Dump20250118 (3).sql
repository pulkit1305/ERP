...
INSERT INTO `companies` VALUES (1,'Bits Computer Institute','pulkit','2024-12-15 08:21:21'),(2,'Company A','company_sample_db','2024-12-15 08:21:50'),(3,'Pulkit Computer Institute','pulkit_computer_institute','2024-12-15 08:22:16'),(4,'Company B','company_b','2024-12-15 08:22:48'),(5,'Company C','company_c','2024-12-15 09:00:09'),(6,'Manik_Institute','manik_institute','2025-01-18 09:52:19');
...
-- Dump completed on 2025-01-18 15:49:39
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: sample_project_db
-- ------------------------------------------------------
-- Server version	8.0.39
...
-- MySQL dump 10.13  Distrib 8.0.38, for Win64 (x86_64)
--
-- Host: 127.0.0.1    Database: company_sample_db
-- ------------------------------------------------------
-- Server version	8.0.39
...
LOCK TABLES `admin` WRITE;
/*!40000 ALTER TABLE `admin` DISABLE KEYS */;
INSERT INTO `admin` VALUES ('Raju','Raj@123',1,NULL),('Rahul Singh','Rahul@123',2,NULL),('Raju sharma','Raju@123',3,NULL),('Manish','Manish@123',4,'Manish@gmail.com'),('rax','Rax@123',5,'rex@gmail.com');
/*!40000 ALTER TABLE `admin` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `admissions` WRITE;
/*!40000 ALTER TABLE `admissions` DISABLE KEYS */;
INSERT INTO `admissions` VALUES (132,160,1,'2024-12-10',0,'REF202412107635'),(133,161,6,'2024-12-10',11,'REF2024121068'),(134,161,2,'2024-12-10',12,'REF202412108625');
/*!40000 ALTER TABLE `admissions` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `courses` WRITE;
/*!40000 ALTER TABLE `courses` DISABLE KEYS */;
INSERT INTO `courses` VALUES (1,'JAVA','OOPs',8000),(2,'React','should know javascript',2000),(3,'JAVA+REACT','JAVA is used as a backend and react is used for a front end \n',20000),(4,'DATA ANALYSIS','In Data Analysis we have  Power BI ,Tabalue etc.',30000),(5,'Cloud Computing ','Cloud computing is a way to access IT resources, like storage, computing power, and databases, over the internet on a pay-as-you-go basis.',45000),(6,'data science','Data science include machine learning',50000);
/*!40000 ALTER TABLE `courses` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `enrollments` WRITE;
/*!40000 ALTER TABLE `enrollments` DISABLE KEYS */;
INSERT INTO `enrollments` VALUES (1,160,1,'2024-12-10',132),(2,161,6,'2024-12-10',133),(3,161,2,'2024-12-10',134);
/*!40000 ALTER TABLE `enrollments` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `payments` WRITE;
/*!40000 ALTER TABLE `payments` DISABLE KEYS */;
INSERT INTO `payments` VALUES (1,'BIL202412105917',160,132,0.00,'2024-12-09 18:30:00',NULL),(2,'BIL202412104322',161,133,11.00,'2024-12-09 18:30:00',NULL),(3,'BIL202412106403',161,134,12.00,'2024-12-09 18:30:00',NULL);
/*!40000 ALTER TABLE `payments` ENABLE KEYS */;
UNLOCK TABLES;
...
LOCK TABLES `users` WRITE;
/*!40000 ALTER TABLE `users` DISABLE KEYS */;
INSERT INTO `users` VALUES (160,'pulkit ranjan',22,'9721346432','pr@gmail.com',NULL,NULL),(161,'soumya',26,'6535623','ss@gmail.com',NULL,NULL);
/*!40000 ALTER TABLE `users` ENABLE KEYS */;
UNLOCK TABLES;
/*!40103 SET TIME_ZONE=@OLD_TIME_ZONE */;
...
-- Dump completed on 2025-01-18 15:49:40
